...
\begin{figure}
	\begin{minipage}[t]{\textwidth}
		...
		\fi
		\caption{\small Schematic of a RNN (taken from Colah's blog)\cite{rnn}}
		\label{bck:rnn}
	\end{minipage}
\end{figure}
...
\subsection{GRU}
The GRU introduced by Cho et al. \cite{bibid} area new type of gated RNN architecture which is has fewer parameters due to the lack of an output gate and is there computationally less complex in comparison to a LSTM.
